...
-- {{{ Tags
tags = {
   names = { "www", "term", "docs", "media", "files", "other" },
...
mytextclock = awful.widget.textclock(markup("#7788af", "%A %d %B ") .. markup("#343639", ">") .. markup("#de5e1e", " %I:%M "))
...
yawn = lain.widgets.yawn(2440190, {
    settings = function()
